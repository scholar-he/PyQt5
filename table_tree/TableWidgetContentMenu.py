...
@Date: 2019/10/8 22:46 
@Description:  在表格中显示上下文菜单
...
import sys
from PyQt5.QtWidgets import (QMenu, QPushButton, QWidget, QTableWidget, QTableWidgetItem, QHBoxLayout, QApplication,
                             QHeaderView)
